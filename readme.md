...
5. Update the identityServices.config with the issuer which you will find by clicking the Endpoints button in the Azure AD App Registration blade. The realm is the APP ID URI and the reply URL should match (note the trailing slash)
